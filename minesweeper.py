            ...
            for s1 in self.knowledge:
                for s2 in self.knowledge:
                    if s1 != s2 and s1.cells.issubset(s2.cells):
                        ...
                        new_inferred = Sentence(diff_cells, diff_count)
                        if new_inferred not in self.knowledge and new_inferred not in inferred_sentences:
                            inferred_sentences.append(new_inferred)
